...
Partial Class Mgm_exchange_DupsGenus
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strQuery = "SELECT familyID, familyE, familyC, genusID, genusE, genusC ,count(*) AS total FROM vwDupStock WHERE familyID = @familyID GROUP BY familyID, familyE, familyC, genusID, genusE, genusC ORDER BY genusE"
