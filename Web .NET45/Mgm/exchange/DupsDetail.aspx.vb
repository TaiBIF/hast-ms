...
Partial Class Mgm_exchange_DupsDetail
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strQuery = "SELECT TOP 3000 CKSN, familyID, familyE, familyC, genusID, genusE, speciesID, speciesE, speciesC, LTRIM(ISNULL(cCollector,'') + ' ') + LTRIM(ISNULL(cCollectNum1,'') + ' ') + LTRIM(ISNULL(cCollectNum2,'') + ' ') AS collectNum, storedSite, blnBored, blnDestroyed, blnNoFlwFruit, specimenOrderNum FROM vwDupStock WHERE " & TransferNull("familyID", 0) & " AND " & TransferNull("genusID", 0) & " AND " & TransferNull("speciesID", 0)
