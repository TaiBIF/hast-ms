...
Partial Class Project_SpeciesDetailC
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ''GMap1.setCenter(New Subgurim.Controles.GLatLng(24.58, 121.42), 14)
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        ...
        Select Case Request.QueryString("QP")
            ...
            Case "TaipeiSuburbs"
                Me.MasterPageFile = "~/MasterPages/TaipeiSuburbsC.master"
    ...
    Protected Sub DBBind()
        ...
        Try
            ...
            'Dim strSQL As String = "prAreaCollection"
