<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/TaipeiSuburbsC.master" AutoEventWireup="false" CodeFile="TaipeiSuburbsListC.aspx.vb" Inherits="Project_TaipeiSuburbsListC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="menu_2"> 
        <asp:Menu ID="Menu2" runat="server" Font-Size="10pt" Orientation="Horizontal" 
            ...
            <Items>
                <asp:MenuItem Text="台北市近郊植物" Value="台北市近郊植物">
                        <asp:MenuItem NavigateUrl="~/Project/TaipeiSuburbsIntroC.aspx" Text="簡介" 
                            Value="簡介"></asp:MenuItem>
                        <asp:MenuItem NavigateUrl="~/Project/TaipeiSuburbsListC.aspx" Text="植物名錄" 
                            Value="植物名錄"></asp:MenuItem>
                        <asp:MenuItem NavigateUrl="~/Project/TaipeiSuburbsHierachicalC.aspx" 
                            Text="植物名錄–階層" Value="植物名錄–階層"></asp:MenuItem>
                        <asp:MenuItem NavigateUrl="~/Project/TaipeiSuburbsQueryC.aspx" Text="植物特徵查詢" 
    ...
    <br />
    <b><label id='top' >台北市近郊 - 植物名錄</label></b>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="listID" 
                    DataNavigateUrlFormatString="~/Project/SpeciesDetailC.aspx?lid={0}&QP=TaipeiSuburbs" 
