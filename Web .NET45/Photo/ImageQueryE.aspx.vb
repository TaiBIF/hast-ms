...
Partial Class Photo_ImageQueryE
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        strRedirectUrl = "~/Photo/ImageClassE.aspx?"

        If TextBoxScientificName.Text.Trim <> "" Then
            strRedirectUrl = strRedirectUrl & "&scientificName=" & TextBoxScientificName.Text.Trim
        End If

        If DDListCollector.SelectedValue <> "" Then  '拍攝者
            strRedirectUrl = strRedirectUrl & "authorID=" & DDListCollector.SelectedValue
        End If
        ...
        If intErrorCharSum >= 0 Then
            ...
            Using testConnetion As New SqlConnection(strConnectionstring)
                ...
                If DDListCollector.SelectedValue <> "" Then
                    ...
                    paramAuthorID.Value = DDListCollector.SelectedValue
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            SDSSql.SelectCommand = "SELECT pid, nameLF FROM vwPersonName WHERE ImageAuthor = 1 ORDER BY nameLFC1"
            ...
            For i = 1 To dv.Count
                DDListCollector.Items.Add(dv.Item(i - 1).Item("nameLF"))
