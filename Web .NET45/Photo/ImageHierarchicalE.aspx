<%@ Page Language="VB" MasterPageFile="~/MasterPageTWFloraE.master" AutoEventWireup="false" CodeFile="ImageHierarchicalE.aspx.vb" Inherits="Photo_ImageHierarchicalE" title="HAST - Living plant images" %>
                        ...
                        <ItemTemplate>
                            <div class="albumpic">
                                <asp:HyperLink ID="HyperLink3" runat="server" 
                                    NavigateUrl='<%# "~/Photo/ImageDetailE.aspx?imageCode=" & Eval("imageCode")%>' 
                                    target="_blank">
