...
Partial Class Photo_ImageClassC
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                If intErrorCharSum >= 0 Then
                    ...
                    If Request.QueryString("photoDate") <> "" Then
                        Dim paramPhotoDate As New SqlParameter("photoDate", TypeCode.DateTime)
                        paramPhotoDate.Direction = Data.ParameterDirection.Input
                        paramPhotoDate.Value = Request.QueryString("photoDate")
                        sqlCommand.Parameters.Add(paramPhotoDate)
                    End If

                    If Request.QueryString("photoDateEnd") <> "" Then
                        ...
                        paramPhotoDateEnd.Value = Request.QueryString("photoDateEnd")
                        sqlCommand.Parameters.Add(paramPhotoDateEnd)
                    End If
    ...
    Protected Sub DataListFamily_ItemCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataListItemEventArgs)
        ...
        CType(e.Item.FindControl("Label6"), Label).Text = "共 " & dv5.Item(0).Item("sumSpecies").ToString & " 種"
