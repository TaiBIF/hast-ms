<%@ Page Language="VB" MasterPageFile="~/MasterPageTWFloraE.master" AutoEventWireup="false" CodeFile="SpeciesDetailE.aspx.vb" Inherits="Taxon_SpeciesDetailE" title="HAST - Species detail infomation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <br />
    <a id="Specimens_Anchor">Specimens</a>
    <br />
    <asp:GridView ID="GridViewSpecimens" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="specimenOrderNum" 
                ...
                DataTextField="specimenOrderNum" HeaderText="HAST ID" >
                <ItemStyle HorizontalAlign="Right" Width="100px" />
            </asp:HyperLinkField>
            <asp:BoundField DataField="collectionLFNo" HeaderText="Collection No." 
                SortExpression="collectionNum" >            
                <ItemStyle HorizontalAlign="Left" Width="250px" />
            </asp:BoundField>
            <asp:BoundField DataField="collectionDate" DataFormatString="{0:d}" 
                HeaderText="collection Date" HtmlEncode="False" 
            ...
            <asp:BoundField DataField="districtE" HeaderText="District" 
                SortExpression="countryProvinceE" >
    ...
    <br />
    <br />
    <a id="Distribution_Anchor">Distribution</a>
    <br />
                ...
                <tr>            
                    <td class="GMaps">
                        <cc1:gmap ID="GMap1" runat="server" DataGIconAnchorField="" DataGIconImageField=""
                            ...
                            Version="2" Width="600px" GZoom="1" Language="En" />
                    </td>            
                    <td style="width: 5px">
                    </td>
                    <td class="GMaps">
            ...
            <ContentTemplate>
                <asp:DataList ID="DataListImages" runat="server"  repeatColumns="5"  
                    ...
                    <ItemStyle VerticalAlign="Top" />      
                        <ItemTemplate>        
                                    <div class="albumpic">
                                        <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl='<%# "~/Photo/ImageDetailE.aspx?imageCode=" & Eval("imageCode") %>' >
