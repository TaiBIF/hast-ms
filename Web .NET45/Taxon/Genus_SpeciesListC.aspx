<%@ Page Language="VB" MasterPageFile="~/MasterPageTWFlora.master" AutoEventWireup="false" CodeFile="Genus_SpeciesListC.aspx.vb" Inherits="Taxon_SpeciesListC" title="HAST - 植物名錄 - 學名" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
 <h3><b><label id='top'   >植物名錄：植物名排序</label></b></h3><br />
