...
Partial Class Taxon_Genus_SpeciesListTwC
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            '        strUpperTaxon = strUpperTaxon & "&nbsp;" & dv1.Item(0).Item("tracheophyteC").ToString
            '        strUpperTaxon = strUpperTaxon & "&nbsp;>&nbsp;" & dv1.Item(0).Item("orderExpr").ToString
    ...
    Protected Sub DataListGenusSpecies_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataListItemEventArgs) Handles DataListGenusSpecies.ItemDataBound
        ...
        ' dataset做dinstinct 效能太差
        ' dv2.Table = _ds.Tables(1).DefaultView.ToTable(True, {"genusID", "speciesID", "speciesE", "speciesC", "speciesExpr"})
