<%@ Page Title="中央研究院 植物標本館 - HAST" Language="VB" MasterPageFile="~/MasterPages/HastMainC.master" AutoEventWireup="false" CodeFile="index.aspx.vb" Inherits="index" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

    <script type="text/javascript" src="HAST/js/jquery.cycle.all.js"></script>
            ...
            <div class="row">
                ...
                <div class="3u 12u(2)" id="QuickSearch" >
                    <div class="wrapper style7">
                        ...
                        <div>
                            <asp:Button ID="btnQuickSearch" runat="server" Text="查詢" />
                        </div>
                    </div>
                </div>
            </div>                               
						...
						<div class="3u 12u(2)">
							<section class="image-feature">
								<a href="#">
									...
									<span class="image fit"><img src="HAST/images/pic02.jpg" alt="" /></span>
									<footer>
						...
						<div class="3u 12u(2)">
							<section class="image-feature">
								<a href="#">
									...
									<span class="image fit"><img src="HAST/images/pic03.jpg" alt="" /></span>
									<footer>
						...
						<div class="3u 12u(2)">
							<section class="image-feature">
								<a href="#">
									...
									<span class="image fit"><img src="HAST/images/pic04.jpg" alt="" /></span>
									<footer>
