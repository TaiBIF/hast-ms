...
Partial Class index
    ...
    Protected Sub Repeater1_ItemDataBound(sender As Object, e As RepeaterItemEventArgs) Handles Repeater1.ItemDataBound
        ...
        Dim strLinkFocus As String = "HAST/plantinfo.aspx?listID="
    ...
    Protected Sub btnQuickSearch_Click(sender As Object, e As EventArgs) Handles btnQuickSearch.Click
        ...
        strRedirectUrl = "~/Taxon/QuickSearchResultC.aspx?"

        If textboxPlantName.Text.Trim <> "" Then
            strRedirectUrl = strRedirectUrl & "&plantName=" & Server.UrlEncode(textboxPlantName.Text.Trim)
        End If
