...
Partial Class Type_TypeListC
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            strQueryFamily = "SELECT distinct verFamilyE, (verFamilyE + ' ' +  COALESCE(verFamilyC,'')) AS familyN FROM vwTypeDetail ORDER BY verFamilyE, familyN "
