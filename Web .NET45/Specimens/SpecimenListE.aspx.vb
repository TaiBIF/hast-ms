...
Partial Class Specimens_SpecimenListE
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            Select Case Session("RequestPage")
                Case "HastQuery"
                    SDSSpecimensList.SelectCommand = "prHastDynaQueryAll"
                    HyperLinkRequery.NavigateUrl = "~/Mgm/secure/HastQuery.aspx"
                    'Case "imageDetail"
                    '    SDSSpecimensList.SelectCommand = "prHastDynaQueryAll"
                    '    HyperLinkRequery.NavigateUrl = "~/HAST/Specimens/SpecimenQuery.aspx"
                Case Else
                    SDSSpecimensList.SelectCommand = "prHastDynaQuery"
                    HyperLinkRequery.NavigateUrl = "~/Specimens/SpecimenQueryE.aspx"
            End Select
            ...
            If Not IsPostBack Then
                ...
                If intErrorCharSum >= 0 Then
                    ...
                    If Request.QueryString("SN") <> "" Then
                        ...
                        SDSSpecimensList.SelectParameters.Add(paramSN)
                    End If
                    ...
                    If Request.QueryString("collectorID") <> "" Then
                        Dim paramCollectorID As New QueryStringParameter("collectorID", TypeCode.Int32, "collectorID")
                        paramCollectorID.Direction = Data.ParameterDirection.Input
                        SDSSpecimensList.SelectParameters.Add(paramCollectorID)
                    End If


                    If Request.QueryString("collectionNum") <> "" Then
                        Dim paramCollectionNum As New QueryStringParameter("collectionNum", TypeCode.Int32, "collectionNum")
                        paramCollectionNum.Direction = Data.ParameterDirection.Input
                        SDSSpecimensList.SelectParameters.Add(paramCollectionNum)
                    End If

                    If Request.QueryString("collectionNumEnd") <> "" Then
                        Dim paramCollectionNumEnd As New QueryStringParameter("collectionNumEnd", TypeCode.Int32, "collectionNumEnd")
                        paramCollectionNumEnd.Direction = Data.ParameterDirection.Input
                        SDSSpecimensList.SelectParameters.Add(paramCollectionNumEnd)
                    End If


                    If Request.QueryString("collectionDate") <> "" Then
                        Dim paramCollectionDate As New QueryStringParameter("collectionDate", TypeCode.DateTime, "collectionDate")
                        paramCollectionDate.Direction = Data.ParameterDirection.Input
                        SDSSpecimensList.SelectParameters.Add(paramCollectionDate)
                    End If


                    If Request.QueryString("collectionDateEnd") <> "" Then
                        Dim paramCollectionDateEnd As New QueryStringParameter("collectionDateEnd", TypeCode.DateTime, "collectionDateEnd")
                        paramCollectionDateEnd.Direction = Data.ParameterDirection.Input
                        SDSSpecimensList.SelectParameters.Add(paramCollectionDateEnd)
                    End If
                    ...
                    If Request.QueryString("collectionMonth") <> "" Then
                        ...
                        SDSSpecimensList.SelectParameters.Add(paramCollectionMonth)
                    End If
                    ...
                    If Request.QueryString("specimenOrderNum") <> "" Then
                        ...
                        SDSSpecimensList.SelectParameters.Add(paramSpecimenOrderNum)
                    End If

                    If Request.QueryString("specimenOrderNumEnd") <> "" Then
                        Dim paramSpecimenOrderNumEnd As New QueryStringParameter("specimenOrderNumEnd", TypeCode.Int32, "specimenOrderNumEnd")
                        paramSpecimenOrderNumEnd.Direction = Data.ParameterDirection.Input
                        SDSSpecimensList.SelectParameters.Add(paramSpecimenOrderNumEnd)
                    End If
                    ...
                    If Request.QueryString("familyID") <> "" Then
                        ...
                        SDSSpecimensList.SelectParameters.Add(paramFamilyID)
                    End If
                    ...
                    If Request.QueryString("genusID") <> "" Then
                        ...
                        SDSSpecimensList.SelectParameters.Add(paramGenusID)
                    End If
                    ...
                    If Request.QueryString("speciesID") <> "" Then
                        ...
                        SDSSpecimensList.SelectParameters.Add(paramSpeciesID)
                    End If
                    ...
                    If Request.QueryString("countryNo") <> "" Then
                        ...
                        SDSSpecimensList.SelectParameters.Add(paramCountryNo)
                    End If
                    ...
                    If Request.QueryString("provinceNo") <> "" Then
                        ...
                        SDSSpecimensList.SelectParameters.Add(paramProvinceNo)
                    End If
                    ...
                    If Request.QueryString("hsienNo") <> "" Then
                        ...
                        SDSSpecimensList.SelectParameters.Add(paramHsienNo)
                    End If
                    ...
                    If Request.QueryString("townNo") <> "" Then
                        ...
                        SDSSpecimensList.SelectParameters.Add(paramTownNo)
                    End If
                    ...
                    If Request.QueryString("parkNo") <> "" Then
                        ...
                        SDSSpecimensList.SelectParameters.Add(paramParkNo)
                    End If
                    ...
                    If Request.QueryString("location") <> "" Then
                        ...
                        SDSSpecimensList.SelectParameters.Add(paramLocation)
                    End If

                    Dim x As Integer
                    For x = 0 To 3
                        If Request.QueryString("altCompare") = x.ToString Then
                            Dim paramAltCompare As New QueryStringParameter("altCompare", TypeCode.Int32, "altCompare")
                            paramAltCompare.Direction = Data.ParameterDirection.Input
                            SDSSpecimensList.SelectParameters.Add(paramAltCompare)
                        End If
                    Next


                    If Request.QueryString("alt") <> "" Then
                        Dim paramAlt As New QueryStringParameter("alt", TypeCode.Int32, "alt")
                        paramAlt.Direction = Data.ParameterDirection.Input
                        SDSSpecimensList.SelectParameters.Add(paramAlt)
                    End If

                    If Request.QueryString("altx") <> "" Then
                        Dim paramAltx As New QueryStringParameter("altx", TypeCode.Int32, "altx")
                        paramAltx.Direction = Data.ParameterDirection.Input
                        SDSSpecimensList.SelectParameters.Add(paramAltx)
                    End If
    ...
    Private Sub setFields()
        ...
        specimenOrderNumField.DataNavigateUrlFormatString = "~/Specimens/SpecimenDetailE.aspx?specimenOrderNum={0}"
        specimenOrderNumField.Target = "_blank"
        specimenOrderNumField.HeaderText = "ID"
        ...
        elevationField.HeaderText = "Altitude(m)"
    ...
    Public Class GridViewTemplate
        ...
        Protected Sub location_DataBinding(ByVal sender As Object, ByVal e As EventArgs)
            ...
            '取得資料繫結
            litLocation.Text = DataBinder.Eval(row.DataItem, "country").ToString & _
            " <br />" & DataBinder.Eval(row.DataItem, "districtE").ToString
        End Sub
